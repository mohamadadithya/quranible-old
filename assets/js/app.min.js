    ...
    <p class="means">${a.artinya}</p>
             ...
             <div>
              <h3 class="name">${a[b].name.transliteration.id}</h3>
               <p class="desc text-gray">${a[b].name.translation.id} • ${a[b].numberOfVerses} ayat</p>
             </div>
